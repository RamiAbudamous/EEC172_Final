...
void writeCommand(unsigned char c)
{
    ...
    // set DC to low
    GPIOPinWrite(CS_DC_BASE, DC_PIN, 0);

    // set CS to low
    GPIOPinWrite(CS_DC_BASE, CS_PIN, 0);
    ...
    // set CS to high
    GPIOPinWrite(CS_DC_BASE, CS_PIN, CS_PIN);
}
//*****************************************************************************
...
void writeData(unsigned char c)
{
    unsigned long ulDummy;
    // set DC to high
    GPIOPinWrite(CS_DC_BASE, DC_PIN, DC_PIN);
